...
namespace NexusPlatform.Application.Interfaces;
...
public interface IUserService
{
    ...
    Task UpdateUserRoleAsync(Guid userId, string role, string? secondaryRole = null);
...
{
    string GenerateAccessToken(Guid userId, string email, string role, string? secondaryRole = null);
