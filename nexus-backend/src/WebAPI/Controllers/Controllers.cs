...
public class UsersController : BaseController
{
    ...
    {
        await _userService.UpdateUserRoleAsync(id, request.Role, request.SecondaryRole);
        return NoContent();
    }
    ...
    [HttpPost("me/avatar")]
    public async Task<ActionResult<UserDto>> UploadAvatar([FromForm] IFormFile file, [FromServices] IFileService fileService)
    {
...
public class UpdateRoleRequest { public string Role { get; set; } = string.Empty; public string? SecondaryRole { get; set; } }
...
public class UploadController : BaseController
{
    ...
    public async Task<IActionResult> Upload(IFormFile file)
    {
        ...
        var allowed = new[] { "image/jpeg", "image/png", "image/gif", "image/webp", "video/mp4", "application/pdf" };
