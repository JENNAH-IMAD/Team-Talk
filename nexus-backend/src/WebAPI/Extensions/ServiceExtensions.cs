...
using NexusPlatform.Application.Mappings;
using NexusPlatform.Application.Services;
using NexusPlatform.Domain.Interfaces;
using NexusPlatform.Infrastructure.Persistence;
using NexusPlatform.Infrastructure.Repositories;
using NexusPlatform.Infrastructure.Security;
using FluentValidation;
using FluentValidation.AspNetCore;

namespace NexusPlatform.WebAPI.Extensions;
