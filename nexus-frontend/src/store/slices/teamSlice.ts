...
export const createChannel = createAsyncThunk(
  'teams/createChannel',
  async ({ teamId, name, description, isPrivate }: { teamId: string; name: string; description: string; isPrivate: boolean }) => {
    const { data } = await apiClient.post(`/teams/${teamId}/channels`, { name, description, isPrivate });
