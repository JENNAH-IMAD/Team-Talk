          ...
          <div className="flex items-center gap-5 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-2 flex-wrap">
                <span className={cn('text-[11px] font-bold px-2 py-0.5 rounded-md border capitalize', ROLE_COLORS[user.role])}>
                  <Shield size={10} className="inline mr-0.5 -mt-px" />{user.role}
                </span>
                {user.secondaryRole && (
                  <span className={cn('text-[11px] font-bold px-2 py-0.5 rounded-md border capitalize', ROLE_COLORS[user.secondaryRole])}>
                    <Shield size={10} className="inline mr-0.5 -mt-px" />{user.secondaryRole}
                  </span>
                )}
              </div>
            </div>
