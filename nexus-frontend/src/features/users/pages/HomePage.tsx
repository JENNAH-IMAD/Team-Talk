...
const HomePage: React.FC = () => {
  ...
  return (
    <div ref={pageRef} className="flex-1 overflow-y-auto p-8">
        ...
        <div className="grid grid-cols-4 gap-3 mb-8">
          {quickActions.map((action, i) => (
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="bg-white dark:bg-surface-900 border border-subtle rounded-xl p-4 text-center hover:shadow-sm transition-shadow group"
            >
              <div
