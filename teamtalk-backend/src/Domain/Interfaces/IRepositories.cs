...
namespace TeamTalk.Domain.Interfaces;
...
{
    Task<IEnumerable<Team>> GetActiveTeamsWithMembersAsync();
...
{
    Task<List<GroupParticipant>> GetByUserIdAsync(Guid userId);
    Task<List<GroupParticipant>> GetByChannelIdAsync(Guid channelId);
}
...
public interface IUnitOfWork : IDisposable
{
    ...
    IGroupParticipantRepository GroupParticipants { get; }
