# Team Talk — Backend API

.NET 8 backend with Clean Architecture for the Team Talk enterprise collaboration platform.
...
1. Install PostgreSQL and create database `teamtalk_platform`
